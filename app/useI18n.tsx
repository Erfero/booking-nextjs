...
const DICT: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    navMyBookings: "Mes réservations",
    testimonialsTitle: "Ce qu'en disent mes clients",
    myBookingsTitle: "Mes réservations",
    myBookingsLead: "Entre ta référence de réservation et l'email utilisé pour la retrouver.",
    lookupIdLabel: "Référence de réservation",
    lookupEmailLabel: "Email",
    lookupSubmit: "Rechercher",
    lookupSearching: "Recherche…",
    lookupNotFound: "Aucune réservation trouvée avec ces informations.",
    cancelBtn: "Annuler ce rendez-vous",
    cancelling: "Annulation…",
    cancelledBadge: "Annulée",
    cancelledNotice: "Cette réservation a été annulée.",
    statusConfirmed: "Confirmée",
    statusCancelled: "Annulée",
    adminSearchPlaceholder: "Rechercher un client…",
    adminFilterDate: "Filtrer par date",
    adminClearFilter: "Réinitialiser",
    adminCancelBtn: "Annuler",
    adminCancelling: "…",
    adminNoResults: "Aucune réservation ne correspond.",
    heroStatBookings: "créneaux réservés en ligne",
    heroStatServices: "prestations",
    heroStatRealtime: "disponibilités en temps réel",
    addToCalendar: "Ajouter au calendrier",
    rescheduleBtn: "Reprogrammer",
    rescheduleTitle: "Choisir un nouveau créneau",
    rescheduleConfirm: "Confirmer le nouveau créneau",
    rescheduling: "Reprogrammation…",
    rescheduleCancel: "Annuler",
    rescheduleSuccess: "Rendez-vous reprogrammé !",
    blockedDatesTitle: "Jours bloqués",
    blockedDatesLead: "Ces dates seront indisponibles à la réservation.",
    blockedDateLabel: "Date",
    blockedReasonLabel: "Motif (optionnel)",
    blockedDatesAdd: "Bloquer cette date",
    blockedDatesEmpty: "Aucun jour bloqué.",
    blockedDatesRemove: "Débloquer",
    statsRevenue: "Revenu (confirmé)",
    statsConfirmed: "Réservations confirmées",
    statsCancelled: "Annulées",
    statsThisWeek: "Cette semaine",
    statsByService: "Par prestation",
  },
  en: {
    brand: "Code4Life Booking",
    ...
    myBookingsLead: "Enter your booking reference and the email used to make it.",
    lookupIdLabel: "Booking reference",
    lookupEmailLabel: "Email",
    lookupSubmit: "Search",
    lookupSearching: "Searching…",
    lookupNotFound: "No booking found with this information.",
    ...
    adminSearchPlaceholder: "Search a client…",
    adminFilterDate: "Filter by date",
    adminClearFilter: "Reset",
    adminCancelBtn: "Cancel",
    adminCancelling: "…",
    adminNoResults: "No booking matches.",
    heroStatBookings: "slots booked online",
    heroStatServices: "services",
    heroStatRealtime: "real-time availability",
    addToCalendar: "Add to calendar",
    rescheduleBtn: "Reschedule",
    rescheduleTitle: "Pick a new slot",
    rescheduleConfirm: "Confirm new slot",
    rescheduling: "Rescheduling…",
    rescheduleCancel: "Cancel",
    rescheduleSuccess: "Appointment rescheduled!",
    blockedDatesTitle: "Blocked days",
    blockedDatesLead: "These dates will be unavailable for booking.",
    blockedDateLabel: "Date",
    blockedReasonLabel: "Reason (optional)",
    blockedDatesAdd: "Block this date",
    blockedDatesEmpty: "No blocked days.",
    blockedDatesRemove: "Unblock",
    statsRevenue: "Revenue (confirmed)",
    statsConfirmed: "Confirmed bookings",
    statsCancelled: "Cancelled",
    statsThisWeek: "This week",
    statsByService: "By service",
  },
};
